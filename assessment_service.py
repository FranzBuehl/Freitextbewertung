...
def assess(request: QuizRequestModel):
    ...
    save_as_competence(quizAssessment)

    return quizAssessment.creation

def save_as_competence(assessment: QuizAssessment):
    ...
    assessmentDict['competence'] = map_competence(assessment.points, assessment.maxPoints)
...
def map_competence(points, maxPoints):
